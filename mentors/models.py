...
class MentorContact(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='mentor_contacts')
    ...
    def __str__(self):
        return f"Contact request for {self.mentor_name} from {self.user.username}"
